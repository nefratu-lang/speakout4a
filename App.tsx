...
const App = () => {
  ...
  const [isFullscreen, setIsFullscreen] = useState(false); // Sadece bu state eklendi
  ...
  // --- SADECE BU FONKSİYON EKLENDİ (TAM EKRAN) ---
  ...
  useEffect(() => {
    ...
    // Ekran değişimini dinle (ESC basarsa ikonu düzeltmek için)
  ...
  const renderSlideContent = () => {
    switch(currentSlide.type) {
      case SlideType.COVER:
        return <CoverSlide data={currentSlide} />; // onNext falan yok, orijinal hali
